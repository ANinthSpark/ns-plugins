...
PLUGIN.desc = "Present a german passport for character identification."
...
if CLIENT then
    netstream.Hook("openReisepass", function(ply, plyReisepassInfo)
        reisepassMenu(ply, plyReisepassInfo)
	end)
